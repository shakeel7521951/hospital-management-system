  ...
  return (
    <div className="container mx-auto px-5 md:px-0 py-10">
      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-5xl font-bold text-gray-800">Hospital Services</h1>
        <p className="text-gray-600 max-w-4xl mx-auto mt-2">
          Our hospital provides world-class healthcare services, specializing in various fields to ensure
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {portfolioItems.map((item, index) => (
          <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
            <img src={item.img} alt={item.category} className="w-full h-64 object-cover" />
